import os
import pickle
from NoisyNLP.features import sent2features, DictionaryFeatures, ClusterFeatures, WordVectors
from NoisyNLP.utils import load_sequences, process_glovevectors

TRAIN_FILE = "wnut16_train"
DEV_FILE = "wnut16_dev"
...
class TwitterNER:
    def __init__(self, training_data_name="_wnut_and_hege",
        ...
        with open(TWITTER_NER_MODEL_FILE % training_data_name, "rb") as pickle_file:
